...
// public:
//     NeedleAnimation(T *needle, PostProcessing<T> *post_processing);
...
//     // // Post Processing handle 
//     PostProcessing<T> *m_post_processing;
...
// template <class T>
// NeedleAnimation<T>::NeedleAnimation(T *needle, PostProcessing<T> *post_processing)
// {
//     m_gp << "set style line 1 lc rgb 'black' lw 1.5\n";
//     m_gp << "set xrange [-0.4:0.4]\nset yrange [-0.4:0.4]\nset zrange [-0.4:0.4]\n";
//     m_gp << "set hidden3d\n";
...
// template <class T>
// void NeedleAnimation<T>::animate(arma::dvec roa_g_g, arma::dvec euler_angles, 
//         arma::dvec elastic_coordinates)
// {
//     // Caclulate the center of the rigid body
//     arma::dmat rot_f_g = EulerRotations::rotation(euler_angles);
...
// template <class T>
// void NeedleAnimation<T>::create_handle(arma::dvec roa_f_f, arma::dvec euler_angles)
// {
//     auto cylinder_pol = cylinder(roa_f_f, euler_angles);
//     auto str_polygons = polygons_to_strings(cylinder_pol);
...
// template <class T>
// std::vector<arma::dmat> NeedleAnimation<T>::cylinder(arma::dvec center,
//     arma::dvec orientation)
// { 
...
// template <class T>
// std::vector<std::vector<std::string>> NeedleAnimation<T>::polygons_to_strings(
//     std::vector<arma::dmat> polygons)
// {
//     std::vector<std::vector<std::string>> str_polygons;
